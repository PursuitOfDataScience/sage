...
renders 720 states clean, the palette has not drifted. When this file was written one cell
...
correct.
    ...
    python tools/scorecard.py --with-layout          # + the 720-render layout harness
